...
const ProjectSec = () => {
  return (
    <div className="w-[95%] h-auto mx-auto flex flex-col justify-center items-center py-14">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
        <div className="transform transition duration-300 hover:scale-110 rounded-lg shadow-lg h-52 w-56 hover:shadow-xl bg-white flex items-center justify-center">
